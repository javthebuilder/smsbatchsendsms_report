...
<head>
    ...
    <title>Batch SMS - Send Info</title>
    <!-- External CSS -->
...
<body>
    ...
    <div class="app-main-body container" style="background-color: #ADD8E6;">
        ...
        <div class="action-area-section container side-wrap">            
            <button type="submit" class="btn btn-success btn-sm"  id="submitBatchButton" onclick="submitMyBatchInfo();"><i class="bi bi-send-check"></i>&nbsp; Batch Send Now</button>
            <a href="./sample/InfoTemplate.xlsx" download="InfoTemplate.xlsx" class="btn btn-primary btn-sm" id="downloadTemplate"><i class="bi bi-file-earmark-arrow-down-fill"></i>&nbsp; Download Template</a>
