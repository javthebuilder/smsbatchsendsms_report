...
<head>
    ...
    <title>Batch SMS - Sending Bills</title>
    <!-- External CSS -->
...
<body>
    ...
    <div class="app-main-body container">
        ...
        <div class="action-area-section container side-wrap">            
            <button type="submit" class="btn btn-success btn-sm"  id="submitBatchButton" onclick="submitMyBatch();"><i class="bi bi-send-check"></i>&nbsp; Batch Send Now</button>
            <a href="./sample/BillsTemplate.xlsx" download="BillsTemplate.xlsx" class="btn btn-primary btn-sm" id="downloadTemplate"><i class="bi bi-file-earmark-arrow-down-fill"></i>&nbsp; Download Template</a>
                ...
                for(let i = 0; i < excelObj.length; i++){
                     ...
                     */
                        ...
                        <td>
                            BILLS 
                            Account:` +
                            excelObj[i].AccountNumber + ` , Amount due is ` +
                            excelObj[i].AmountDue.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}) + `. Period of ` +
                            excelObj[i].Period.toString() + `. Due date will be ` +
                            excelObj[i].DueDate + `.
